"""
Django settings for calicutstar_project project.
...
SECRET_KEY = 'django-insecure-+u7tj!a&u&8s#y@-t7-!e3$1-3a*(_3qwf$(g8j(8_hlnu5lza'
...
ROOT_URLCONF = 'calicutstar_project.urls'
...
WSGI_APPLICATION = 'calicutstar_project.wsgi.application'
